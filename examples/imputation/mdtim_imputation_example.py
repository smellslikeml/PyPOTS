"""
A minimalist, standalone example of the PyPOTS MDTIM model for time-series imputation.
...
def main():
    ...
    # 4. Train the model
    print("🚀 Training the MDTIM model...")
    model.fit(train_set, val_set)

    # 5. Impute missing values
    print("🔮 Imputing missing values...")
    # for generation models like MDTIM, we can sample multiple times to get multiple predictions per data instance
    results = model.predict(test_set, n_sampling_times=2)
    ...
    print(f"✅ The MSE of MDTIM imputation is: {mse:.4f}")
